...
The CC BY 4.0 policy applies to the workbook release artifact and open dataset metadata, subject to the field-level caveat below.
...
When using the release, cite CantHarm and state the version:
